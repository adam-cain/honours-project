...
export default function HomePage() {
  return (
    <main>
      <HomeNav />
      <section className=" bg-gradient-radial from-stone-900 to-black mt-[72px] min-h-[90vh] bottom-0">
        <div className="h-[80vh] mx-20 my-2 overflow-clip flex flex-col justify-center text-2xl align-middle">
